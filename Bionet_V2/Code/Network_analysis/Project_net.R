...
project_net<-function(net,mb,idx_tax,idxs_plots,levels,clust){   #net=metanerwork, mb=occurrence matrix with columns retained_taxa and point replicates, clust=labels of clustering
