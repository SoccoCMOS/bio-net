...
# -----------------------------------------------------------------------------
# STEP:
#    1.2    Building a Gaussian-SBM on weighted interactions 
...
# data load
# -----------------------------------------------------------------------------
adjacence_esp_weighted <- read.csv2("adjacence_esp_weighted.csv", h = T, sep =";")
# -----------------------------------------------------------------------------

# -----------------------------------------------------------------------------
# Building trophic groups through Stochastic Block Modelling
# -----------------------------------------------------------------------------    
my_model <- BM_gaussian("SBM", adjacence_esp_weighted,
                         verbosity=6,
...
write.csv2(SBM_member, "SBM_Gauss_class.csv")
write.csv2(SBM_adj, "SBM_Gauss_adj.csv")
# -----------------------------------------------------------------------------
